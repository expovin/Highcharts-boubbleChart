define( [
			"qlik", 
			"text!./Highcharts-boubbleChart.ng.html", 
			"css!./Highcharts-boubbleChart.css",
			...
			"./js/settings/xAxisSettings",							// Variable with the plotOption settings
			"./js/settings/yAxisSettings"							// Variable with the plotOption settings
	...
	me.definition.items.xAxis = xAxisSettings;
	me.definition.items.yAxis = yAxisSettings;
	...
	me.paint = function($element,layout) {
		...
		*/
			...
			var mychart =  {
					...
					mychart.xAxis = makeXAxis (layout.settings.xAxis);

					mychart.yAxis = makeYAxis(layout.settings.yAxis);
