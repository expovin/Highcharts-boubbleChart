			...
			items : {
						markerEnabled: {
							...
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('marker') != -1);
							}
						},
						markerFillColor: {
							type: "integer",
...
var GeneralSection = {
		    ...
		    items : {
				allowPointSelectCheckbox: {
					...
					defaultValue: false,										
					show : function(data) {			// Showed for all Chart but gauge and solidgaude
						return ( PlotOptionChartMap['bubble'].indexOf('allowPointSelect') != -1);
					}
				},
						animationCheckbox: {
							type: "boolean",
							...
							defaultValue: true,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('animation') != -1);
							}
						},
						animationLimit: {
							type: "string",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('animationLimit') != -1);
							}
						},
						borderColor: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('borderColor') != -1 );
							}
						},
						borderRadius: {
							type: "number",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('borderRadius') != -1);
							}
						},
						borderWidth: {
							type: "number",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('borderWidth') != -1);
							}
						},
						color: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('color') != -1);
							}
						},
						colorByPoint: {
							type: "boolean",
							...
							defaultValue: false,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('colorByPoint') != -1);
							}
						},
						connectEnds: {
							type: "boolean",
							...
							defaultValue: true,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('connectEnds') != -1);
							}
						},
						connectNulls: {
							type: "boolean",
							...
							defaultValue: false,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('connectNulls') != -1);
							}
						},
						cropThreshold: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('cropThreshold') != -1);
							}
						},
						cursor: {
							type: "string",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('cursor') != -1);
							}
						},
						dashStyle: {
							type: "string",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('dashStyle') != -1);
							}
						},
						depth: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('depth') != -1);
							}
						},
						enableMouseTracking: {
							type: "boolean",
							...
							defaultValue: false,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('enableMouseTracking') != -1);
							}
						},
						fillColor: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('fillColor') != -1 );
							}
						},
						fillOpacity: {
							type: "number",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('fillOpacity') != -1);
							}
						},
						getExtremesFromAll: {
							type: "boolean",
							...
							defaultValue: false,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('getExtremesFromAll') != -1);
							}
						},
						groupPadding: {
							type: "number",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('groupPadding') != -1);
							}
						},
						groupZPadding: {
							type: "number",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('groupZPadding') != -1);
							}
						},
						keys: {
							type: "string",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('keys') != -1);
							}
						},
						lineColor: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('lineColor') != -1 );
							}
						},
						lineWidth: {
							type: "number",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('lineWidth') != -1);
							}
						},
						linecap: {
							type: "string",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('linecap') != -1);
							}
						},
						linkedTo: {
							type: "string",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('linkedTo') != -1);
							}
						},
						negativeColor: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('negativeColor') != -1 );
							}
						},
						negativeFillColor: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('negativeFillColor') != -1 );
							}
						},
						pointInterval: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('pointInterval') != -1);
							}
						},
						pointIntervalUnit: {
							type: "string",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('pointIntervalUnit') != -1);
							}
						},
						pointIntervalPlacement: {
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('pointIntervalPlacement') != -1);
							}
						},
						pointStart: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('pointStart') != -1);
							}
						},
						selected: {
							type: "boolean",
							...
							defaultValue: false,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('selected') != -1);
							}
						},
						shadow: {
							type: "boolean",
							...
							defaultValue: false,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('shadow') != -1);
							}
						},
						showCheckbox: {
							type: "boolean",
							...
							defaultValue: false,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('showCheckbox') != -1);
							}
						},
						showInLegend: {
							type: "boolean",
							...
							defaultValue: true,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('showInLegend') != -1);
							}
						},
						softThreshold: {
							type: "boolean",
							...
							defaultValue: false,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('softThreshold') != -1);
							}
						},
						stacking: {
							type: "string",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('stacking') != -1);
							}
						},
						step: {
							type: "boolean",
							...
							defaultValue: false,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('step') != -1);
							}
						},
						stickyTracking: {
							type: "boolean",
							...
							defaultValue: true,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('stickyTracking') != -1);
							}
						},
						threshold: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('threshold') != -1);
							}
						},
						trackByArea: {
							type: "boolean",
							...
							defaultValue: false,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('trackByArea') != -1);
							}
						},
						turboThreshold: {
							type: "integer",
							...
							show : function(data) {
								return ( PlotOptionChartMap['bubble'].indexOf('turboThreshold') != -1);
							}
						},
						visible: {
							type: "boolean",
							...
							defaultValue: true,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('visible') != -1);
							}
						}
		    }
			...
			label: "Data Lables",
			    items : {
						dataLabelsEnabled: {
							...
							defaultValue: true,										
							show : function(data) {			// Showed for all Chart but gauge and solidgaude
								return (PlotOptionChartMap['bubble'].indexOf('dataLabels') != -1);
							}
						},
